...
# domain-attachment functions (prepare_domain_fragment, compute_domain_surface_mask,
# add_domain_to_fragment_list, the dimer-library helpers, build_domain_junction_fragment)
# used to live in this module; they moved to chain_growth.domain_attachment for
# organization, and are re-exported here unchanged so existing
# `from chain_growth.fragment_list import ...` call sites keep working
from chain_growth.domain_attachment import (
    prepare_domain_fragment, compute_domain_surface_mask, add_domain_to_fragment_list,
    DIMER_LIBRARY_RESIDUE_ORDER, dimer_library_fragment_dir, build_domain_junction_fragment)
